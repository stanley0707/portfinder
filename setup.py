...
"""
Ок) все линтеры и mypy работают) давай сделаем из этого проекта консольную утилиту для mac os и linux) модуль pypi потом) Сейчас структура проеута такая portex/
├── portex/
│   ├── __init__.py         # Основной пакет
│   ├── __main__.py         # Точка входа (python -m portex)
│   ├── scanner.py         # Логика сканирования
│   ├── utils.py         # утилитарные функции
│   └── dto.py           # Типы данных
├── pyproject.toml         # Конфигурация Poetry
├── poetry.lock         # Конфигурация Poetry
├── README.md              # Пустая документация
"""
